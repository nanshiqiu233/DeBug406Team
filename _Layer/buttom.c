...
void _ADCSwitcher(int adc)
{
  switch(adc)
  {
  case 1: _Switcher(0, 1, 0); break;
  case 2: _Switcher(1, 0, 1); break;
  case 3: _Switcher(0, 0, 1); break;
  case 4: _Switcher(1, 1, 1); break;  
  case 5: _Switcher(0, 0, 0); break;
  case 6: _Switcher(1, 1, 0); break;
  case 7: _Switcher(0, 1, 1); break;
  case 8: _Switcher(1, 0, 0); break;
